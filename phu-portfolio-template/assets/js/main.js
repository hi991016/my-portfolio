...
const link = document.querySelectorAll('nav > .hover-this, .home__container > .hover-this');
...
document.addEventListener("mousemove", function (e) {
    if (
        ...
        if (
            ...
            let valueXLeft = (img.getBoundingClientRect().width/2 - (e.x - img.getBoundingClientRect().x))/15;
        ...
        if (
            ...
            let valueXRight = (e.x - img.getBoundingClientRect().x - img.getBoundingClientRect().width/2)/15;
        ...
        if (
            ...
            let valueYTop = (img.getBoundingClientRect().height/2 - (e.y - img.getBoundingClientRect().y))/15;
        ...
        if (
            ...
            let valueXBottom = (e.y - img.getBoundingClientRect().y - img.getBoundingClientRect().height/2)/15;
